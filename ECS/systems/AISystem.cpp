...
void engine::AISystem::playSafe(AI::Direction dir, engine::Transform &tr, engine::AISystem::CollideMap &map, ControllerInput &inp UNUSED, AI &ai)
{
...
void engine::AISystem::playAggressive(ECS::World &world, ECS::Guid entity, engine::Transform &tr, engine::AISystem::CollideMap &map, ControllerInput &inp UNUSED, AI &ai)
{
    const int posX = tr.position.x + 0.5f;
    const int posZ = tr.position.z + 0.5f;
